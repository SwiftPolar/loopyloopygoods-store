...
Refer to this [Medusa Admin User Guide](https://docs.medusajs.com/user-guide/reset-password) to learn how to reset your user admin password using the dashboard.
...
1. The user requests to reset their password either through the frontend (for example, [Medusa Admin](https://docs.medusajs.com/user-guide/reset-password)) or the [Generate Reset Password Token API route](https://docs.medusajs.com/commerce-modules/auth/authentication-route#generate-reset-password-token-route).
...
3. The user receives the notification and clicks on the link to reset their password.
   - The user can reset their password either through the frontend (for example, [Medusa Admin](https://docs.medusajs.com/user-guide/reset-password)) or the [Reset Password API route](https://docs.medusajs.com/commerce-modules/auth/authentication-route#reset-password-route).
...
Medusa provides providers like [SendGrid](https://docs.medusajs.com/infrastructure-modules/notification/sendgrid) and [Resend](https://docs.medusajs.com/integrations/guides/resend), and you can also [create your own custom provider](https://docs.medusajs.com/references/notification-provider-module).

Refer to the [Notification Module](https://docs.medusajs.com/infrastructure-modules/notification#what-is-a-notification-module-provider) documentation for a list of available providers and how to set them up.

### Testing with the Local Notification Module Provider

For testing purposes, you can use the [Local Notification Module Provider](https://docs.medusajs.com/infrastructure-modules/notification/local) by adding this to your `medusa-config.ts`:
...
To create a [subscriber](https://docs.medusajs.com/learn/fundamentals/events-and-subscribers) that handles the `auth.password_reset` event, create the file `src/subscribers/password-reset.ts` with the following content:
...
The page shows the user password fields to enter their new password, then submits the new password, token, and email to the [Reset Password Route](https://docs.medusajs.com/commerce-modules/auth/authentication-route#reset-password-route).
...
- [Storefront Guide: Reset Customer Password](https://docs.medusajs.com/storefront-development/customers/reset-password)
...
Refer to the [SendGrid Notification Module Provider](https://docs.medusajs.com/infrastructure-modules/notification/sendgrid) documentation for more details on how to set up SendGrid.
...
<html>
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <p class="text">Hello{{#if email}} {{email}}{{/if}},</p>
        <p class="text">
      ...
      <div class="url-section">
        <p class="text">Or copy and paste this URL into your browser:</p>
...
If you've integrated Resend as explained in the [Resend Integration Guide](https://docs.medusajs.com/integrations/guides/resend), you can add a new template for password reset emails at `src/modules/resend/emails/password-reset.tsx`:
